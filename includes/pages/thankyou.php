...
$venmo_note = sprintf( esc_html__( 'Order %1s checkout at %2s', 'momo-venmo' ), $order_id, get_site_url() );
...
echo ' ' . esc_html__('or Scan', 'momo-venmo' ) . ' > <a class="paym_link" href="https://venmo.com/', esc_attr( wp_kses_post( $this->ReceiverVenmo ) ), '?txn=pay&amount=' , esc_attr( wp_kses_post( $amount  ) ), '&note=', urlencode($venmo_note), '" target="_blank"><img width="100" height="100" class="momo-img" alt="Venmo link"
