...
$note = 'Your order was received!'.'<br><br>'.
	'We are checking our Venmo to confirm that we received the <strong style="text-transform:uppercase;">' . $total . '</strong> you sent so we can start processing your order.'.'<br><br>'.
